...
import { isAutoGeneratedWallet } from './utils/wallet-seed';
  ...
  return (
    <>
      ...
      <Routes>
        ...
        {/* AUTO-WALLET: If auto-generated wallet exists, go directly to wallet */}
        {isAutoGeneratedWallet() && <Route path="/" element={<Navigate to="/wallet" replace />} />}
