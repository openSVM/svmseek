...
export const TradeLink = ({ isActive }: { isActive: boolean }) => {
  return (
    <StyledA target="_blank" href="https://svmseek.com/chart/spot/CCAI_USDC">
      <svg
        width="100%"
        height="100%"
        viewBox="0 0 19 18"
...
export const PoolsLink = ({ isActive }: { isActive: boolean }) => {
  return (
    <StyledA target="_blank" href="https://svmseek.com/pools">
      <svg
        width="100%"
        height="100%"
        viewBox="0 0 27 26"
      ...
      >
        <path
          ...
          fillRule="evenodd"
          clipRule="evenodd"
          d="M1.67102 13.1266L2.42495 13.8143C2.87784 14.2342 3.09651 14.0954 3.38265 13.9138C3.5638 13.7988 3.772 13.6667 4.08378 13.6483C4.49699 13.6377 4.88699 13.6941 5.2642 13.7487C5.72605 13.8155 6.16874 13.8796 6.61144 13.8143C6.96681 13.7619 7.32217 13.6216 7.67754 13.4812C8.12643 13.3039 8.57531 13.1266 9.0242 13.1266C9.49491 13.1266 9.96561 13.3216 10.4594 13.5261C10.8092 13.671 11.1707 13.8207 11.5519 13.9092C12.0545 14.0277 12.5572 14.0074 13.0598 13.987C13.3614 13.9747 13.663 13.9625 13.9646 13.9803C14.2863 13.9993 14.608 14.0486 14.9297 14.0979C15.4123 14.1719 15.8948 14.2459 16.3774 14.2174C17.1618 14.1943 18.0556 13.8779 18.8454 13.5983C18.8654 13.5912 18.8852 13.5842 18.905 13.5772C19.7093 13.2926 20.5135 13.0555 21.3178 13.008C22.122 12.9606 22.9263 13.1266 23.7306 13.4112C23.9807 13.4886 24.2223 13.5748 24.4577 13.6588C25.0874 13.8835 25.6728 14.0924 26.2582 14.0752V15H25.9295L25.071 18L22.7037 21.7427L18.5987 24.5L13.6199 26L9.13909 24.5L4.53573 21.7427L2.16889 18L1.73963 15H1.67102V14.5205V13.1266Z"
          fill={isActive ? '#651CE4' : '#F5F5FB'}
        />
        <path
          d="M26.5642 13C26.5642 16.4478 25.2004 19.7544 22.7728 22.1924C20.3452 24.6304 17.0527 26 13.6196 26C10.1865 26 6.89393 24.6304 4.46633 22.1924C2.03874 19.7544 0.674927 16.4478 0.674927 13H1.64756C1.64756 16.1888 2.9089 19.2469 5.15409 21.5017C7.39928 23.7565 10.4444 25.0232 13.6196 25.0232C16.7948 25.0232 19.8399 23.7565 22.0851 21.5017C24.3303 19.2469 25.5916 16.1888 25.5916 13H26.5642Z"
          fill={isActive ? '#651CE4' : '#F5F5FB'}
        />
      </svg>
...
export const SwapsLink = ({ isActive }: { isActive: boolean }) => {
  return (
    <StyledA target="_blank" href="https://svmseek.com/swap">
      <svg
        width="100%"
        height="100%"
        viewBox="0 0 18 16"
...
export const RebalanceLink = ({ isActive }: { isActive: boolean }) => {
  return (
    <StyledA target="_blank" href="https://svmseek.com/rebalance">
      <svg
        width="100%"
        height="100%"
        viewBox="0 0 23 16"
...
export const DashboardLink = ({ isActive }: { isActive: boolean }) => {
  return (
    <StyledA target="_blank" href="https://svmseek.com/dashboard">
      <svg
        width="100%"
        height="100%"
        viewBox="0 0 17 17"
...
export const StakingLink = ({ isActive }: { isActive: boolean }) => {
  return (
    <StyledA target="_blank" href="https://svmseek.com/staking">
      <svg
        width="100%"
        height="100%"
        viewBox="0 0 17 16"
